...
class leket_DB(models.Model):
    ...
    leket_location = models.CharField(("leket_location"), max_length=200)
    ...
    napa_name = models.CharField(("napa_name"), max_length=200)
    aklim_area = models.CharField(("aklim_area"), max_length=200, null=True)
    TMY_station = models.CharField(("TMY_station"), max_length=200, null=True)
    station = models.CharField(("station"), max_length=200, null=True)
